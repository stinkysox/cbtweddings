...
export const siteContent = {
  ...
  home: {
    hero: {
      title: "Capturing the",
      titleAccent: "Soul", 
      titleEnd: "of Connection",
      subtitle: "Luxury Wedding Cinematography & Photography",
  ...
  contact: {
    hero: {
      label: "Inquiries",
      title: "Connect.",
      description: "Available for commissions globally. We only accept a select number of stories each year to ensure our signature quality.",
    },
    info: {
      studio: {
        title: "The Studio",
  ...
  book: {
    hero: {
      title: "Reservation",
      subtitle: "Let's craft your masterpiece together",
    },
    form: {
      name: "Full Name",
      email: "Email Address",
      ...
      successMessage: "Thank you for considering us. Our boutique team will review your story and get back to you within 48 hours.",
    },
    eventTypes: [
  ...
  footer: {
    ...
    directory: [
      { name: "The Studio Home", path: "/" },
      { name: "Our Philosophy", path: "/about" },
      { name: "The Portfolio", path: "/gallery" },
